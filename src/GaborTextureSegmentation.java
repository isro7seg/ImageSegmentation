...
public class GaborTextureSegmentation {
    ...
    * Default constructor
    */
   public GaborTextureSegmentation() {
      this(DEFAULT_WAVE_LENGTH);
   }

   public GaborTextureSegmentation(double waveLength) {
      this(waveLength, DEFAULT_ORIENTATIONS);
   }

   public GaborTextureSegmentation(double waveLength, double[] orientations) {
      this(waveLength, orientations, DEFAULT_PHASE_OFFSET);
   }

   public GaborTextureSegmentation(double waveLength, double[] orientations, double phaseOffset) {
      this(waveLength, orientations, phaseOffset, DEFAULT_ASPECT_RATIO);
   }

   public GaborTextureSegmentation(double waveLength, double[] orientations, double phaseOffset, double aspectRatio) {
      this(waveLength, orientations , phaseOffset, aspectRatio, DEFAULT_BANDWIDTH);
   }

   public GaborTextureSegmentation(double waveLength, double[] orientations, double phaseOffset, double aspectRatio, double bandwidth) {
      this(waveLength, orientations, phaseOffset, aspectRatio, bandwidth, DEFAULT_WIDTH, DEFAULT_HEIGHT);
   }

   public GaborTextureSegmentation(double waveLength, double[] orientations, double phaseOffset, double aspectRatio, double bandwidth, int width, int height) {
